...
object Slider {
    val slider by lazy { "com.github.denzcoskun:ImageSlideshow:${Versions.sliderVersion}" }
}

object GradlePlugin{
    val gradlePlugin by lazy { "org.jetbrains.kotlin:kotlin-gradle-plugin:${Versions.gradlePlugin}" }
